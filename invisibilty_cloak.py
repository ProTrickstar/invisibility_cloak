...
# Generating Mass to detcet color
...
#Selecting only the part that doesent have mask_1 and saving in mask_2
    mask_2 = cv2.bitwise_not(mask_1)

#Keeping only the part of the images without the red color or any other color you may choose
    res_1 = cv2.bitwise_and(img,img,mask = mask_2)

#Keeping only the part of images with red color or with any other color you may choose
